    ...
    <div className="space-y-5 max-w-5xl">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <div className="space-y-3">
          <p className="font-bold text-sm uppercase tracking-wider" style={{ color: "#9c8fa0" }}>Page Content</p>
          {sections.map(s => (
            <div key={s.key} className="bg-white rounded-2xl border p-4 transition-all hover:shadow-sm"
              style={{ borderColor: editing === s.key ? "#a855f7" : "#ede9f0" }}>
              <p className="text-[10px] font-bold uppercase tracking-wider mb-2" style={{ color: "#9c8fa0" }}>
                {s.label}
              </p>
              ...
              {editing === s.key ? (
                ...
                <div className="flex items-start justify-between gap-3">
                  <p className="text-sm line-clamp-2 flex-1" style={{ color: "#2d2438" }}>
                    {content[s.key]}
                  </p>
        ...
        {/* Live preview */}
        <div>
          <p className="font-bold text-sm uppercase tracking-wider mb-3" style={{ color: "#9c8fa0" }}>Live Preview</p>
          <div className="bg-white rounded-2xl border overflow-hidden sticky top-4" style={{ borderColor: "#ede9f0" }}>
            <div className="h-44 bg-cover bg-center relative"
              style={{ backgroundImage: `url(${content.heroImage})`, background: "#1a1825" }}>
            ...
            <div className="p-5 space-y-4">
              <div>
                <p className="text-[10px] font-bold uppercase tracking-wider mb-1" style={{ color: "#9c8fa0" }}>About</p>
                <p className="text-sm" style={{ color: "#2d2438" }}>{content.aboutSection}</p>
              </div>
              <div className="pt-3 border-t grid grid-cols-2 gap-3" style={{ borderColor: "#f3f0f6" }}>
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-wider mb-1" style={{ color: "#9c8fa0" }}>Email</p>
                  <p className="text-xs font-semibold" style={{ color: "#a855f7" }}>{content.contactEmail}</p>
                </div>
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-wider mb-1" style={{ color: "#9c8fa0" }}>Phone</p>
                  <p className="text-xs font-semibold" style={{ color: "#a855f7" }}>{content.contactPhone}</p>
                </div>
              </div>
            </div>
          </div>
